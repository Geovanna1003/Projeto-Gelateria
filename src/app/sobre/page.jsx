    ...
    return (
        <main>
            ...
            <section className={estilos.sobreNos}>
                <div className={estilos.texto_sobreNos}>
                    <h2>Sobre Nós</h2>
            ...
            <section className={estilos.imageSobre}>
                <div className={estilos.imagemSobre}>
                    <Image className={estilos.img} src={imagem1} alt="sorvetes com amigos" />
                    <Image className={estilos.img} src={imagem2} alt="Sorveteria" />
