  ...
  return (
    <main className={estilos.main}>
     ...
     <section className={estilos.home}>
       <div className={estilos.text_home}>
     ...
     <section className={estilos.secao_nossos_eventos}>
       ...
       <Image className={estilos.img_card} src={image2} alt="Eventos" />
     </section>
     <section className={estilos.secao_sobre_nos}>
      <Image className={estilos.img_card} src={image3} alt="sorvetes com amigos" />
      <div className={estilos.container_texto}>
        <h2>SOBRE NÓS</h2>
